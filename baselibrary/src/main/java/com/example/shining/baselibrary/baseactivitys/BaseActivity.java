 ...
 */
package com.example.shining.baselibrary.baseactivitys;
...
import com.example.shining.baselibrary.loading.ShowLoadingUtil;
...
import com.example.shining.libutils.utilslib.app.ViewHelper;
...
//        MobEvent.onPause(this);
    ...
    public void startActivityForResult(Intent intent, int requestCode) {
        if (intent.resolveActivity(getPackageManager()) == null) {
            MyLogUtil.e("Activity", "No Activity found to handle intent " + intent);
            return;
        }
...
//        overridePendingTransition(R.anim.open_main, R.anim.close_next);
    ...
    public void onHomePressed() {
        finish();
        while (!AppManager.getInstance().getAll().isEmpty()) {
            AppManager.getInstance().top().finish();
        }
