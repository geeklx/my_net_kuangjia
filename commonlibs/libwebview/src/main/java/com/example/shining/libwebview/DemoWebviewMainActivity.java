package com.example.shining.libwebview;
    ...
    private void init() {
        ...
        findViewById(R.id.tv1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // action跳转
                // hios://com.example.shining.libwebview.activity.NoHiosMainActivity
                // action跳转带参数
                // hios://com.example.shining.libwebview.activity.NoHiosMainActivity?skuId={s}value&category_id={s}category_id_value
                // action跳转带参数并且弹出窗
                // hios://com.example.shining.libwebview.activity.NoHiosMainActivity?act={i}1&sku_id={s}value&category_id={s}category_id_value&playing={b}false
                // value为商品的Activity包名sku_id    category_id_value为分类Activity包名category_id
                // hios://com.example.shining.libwebview.activity.NoHiosMainActivity?act={i}1&sku_id={s}341703311759500256
//                HiosHelper.resolveAd(DemoWebviewMainActivity.this, DemoWebviewMainActivity.this, "hios://.activity.NoHiosMainActivity?act={i}1&sku_id={s}2a&category_id={s}3a");
                HiosHelper.resolveAd(DemoWebviewMainActivity.this, DemoWebviewMainActivity.this, "hios://com.example.shining.libwebview.activity.NoHiosMainActivity?act={i}1&sku_id={s}2a&category_id={s}3a");
            }
        });
